...
public class Player {
	...
	/* 
	 * The id of this player for identifying different instances representing the
	 * same player between the server and client. An id of 0 is given if this player
	 * has not yet received an id from the server.
	 */
	private int id;
	 ...
	 * to call one of the other constructors taking arguments.
	 */
	public Player() {
		this(0, "user", 0);
	}
	 ...
	 * 
	 * @param id This player's id. Should be positive, or 0 if this player has not yet
	 ...
	 * received an id from the server.
	 * @param nick The nickname of this player.
	 * @param gameId The id of the game the user is in. Should be a positive integer or 0
	 * if the user is not in any game.
	 */
	 ...
	 * 
	 * @return True iff the user has been registered with the server (i.e. has a non-zero, positive id).
	 */
	 ...
	 * 
	 * @param other Another player object to be compared.
	 * 
